...
func (s *PostgreSQLServer) EnableExtension(name string) error {
...
func (s *PostgreSQLServer) createExtension(name string) error {
...
func (s *PostgreSQLServer) doesExtensionExist(name string) (bool, error) {
	var result int64
