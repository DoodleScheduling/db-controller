...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgreSQLRootCredential) DeepCopyInto(out *PostgreSQLRootCredential) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgreSQLRootCredential.
func (in *PostgreSQLRootCredential) DeepCopy() *PostgreSQLRootCredential {
	if in == nil {
		return nil
	}
	out := new(PostgreSQLRootCredential)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PostgreSQLSpec) DeepCopyInto(out *PostgreSQLSpec) {
	*out = *in
	out.RootCredential = in.RootCredential
	if in.Credentials != nil {
		in, out := &in.Credentials, &out.Credentials
		*out = make(PostgreSQLCredentials, len(*in))
		copy(*out, *in)
